...
<fieldset class="sui-form-field">
	...
	<label class="sui-settings-label"><?php esc_html_e( 'Submissions Retention', 'wordpress-popup' ); ?></label>

	<span class="sui-description"><?php esc_html_e( 'Choose how long to retain each module’s submissions for.', 'wordpress-popup' ); ?></span>
		...
		<div class="sui-tabs-content">
			<div class="sui-tab-boxed<?php echo ! $retain_submission_forever ? ' active':''; ?>" data-tab-content="retention-number">
				<div class="sui-row">
					...
					<div class="sui-col-md-6" >
						<select name="submissions_retention_number_unit">
							<option value="days" <?php selected( 'days', $submissions_retention_unit, true ); ?>><?php esc_html_e( 'day(s)', 'wordpress-popup' ); ?></option>
							<option value="weeks"  <?php selected( 'weeks', $submissions_retention_unit, true ); ?>><?php esc_html_e( 'week(s)', 'wordpress-popup' ); ?></option>
							<option value="months" <?php selected( 'months', $submissions_retention_unit, true ); ?>><?php esc_html_e( 'month(s)', 'wordpress-popup' ); ?></option>
							<option value="years" <?php selected( 'years', $submissions_retention_unit, true ); ?>><?php esc_html_e( 'year(s)', 'wordpress-popup' ); ?></option>
						</select>
					</div>
				</div>
			</div>
