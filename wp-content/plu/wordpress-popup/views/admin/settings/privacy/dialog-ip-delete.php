	...
	<div class="sui-dialog-content" aria-labelledby="dialog-delete--title" aria-describedby="dialog-delete--description" role="dialog">
		...
		<div class="sui-box" role="document">
			...
			<div class="sui-box-header sui-block-content-center">
				...
				<h3 id="dialog-delete--title" class="sui-box-title"><?php esc_html_e( 'Delete IP Addresses', 'wordpress-popup' ); ?></h3>

				<p id="dialog-delete--description" class="sui-description" style="margin-bottom: 0;"><?php esc_html_e( 'Choose the IP addresses you want to delete from your database permanently. Note that this will only remove the IP addresses from the database leaving rest of the tracking data intact.', 'wordpress-popup' ); ?></p>
			...
			<form id="hustle-delete-ip-form" class="sui-box-body sui-box-body-slim">
				...
				<label class="sui-label" style="margin-bottom: 5px;"><?php esc_html_e( 'Delete IP Addresses', 'wordpress-popup' ); ?></label>
				...
				<div class="sui-side-tabs">
					...
					<div class="sui-tabs-content">
						...
						<div class="sui-tab-boxed"
							...
							<label for="hustle-remove-specific-ips" class="sui-label"><?php esc_html_e( 'Delete Specific IPs', 'wordpress-popup' ); ?></label>
			...
			<div class="sui-box-footer sui-outlined">
				...
				>
					<span class="sui-loading-text">
						<i class="sui-icon-trash" aria-hidden="true"></i> <?php esc_html_e( 'Delete IP Addresses', 'wordpress-popup' ); ?>
					</span>
