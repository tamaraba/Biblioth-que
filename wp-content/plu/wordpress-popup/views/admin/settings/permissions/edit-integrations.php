<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-1">
		<span class="sui-settings-label"><?php esc_html_e( 'Edit Integrations', 'wordpress-popup' ); ?></span>
		<span class="sui-description"><?php esc_html_e( 'Choose the user roles which can access the Integrations page and connect or disconnect Hustle to 3rd party apps.', 'wordpress-popup' ); ?></span>
	</div>
