		...
		<div class="sui-box" role="document">
			...
			<div class="sui-box-body sui-box-body-slim sui-block-content-center">
				...
				<div id="hustle-integration-active-modules" class="hustle-active-module-list">
					...
					<span class="sui-label" style="padding-left: 10px;"><?php esc_html_e( 'Modules', 'wordpress-popup' ); ?></span>
			...
			<div class="sui-box-footer sui-box-footer-center">
				...
				>
				<span class="sui-loading-text"><?php esc_html_e( 'DISCONNECT ANYWAY', 'wordpress-popup' ); ?><i class="sui-icon-loader sui-loading" aria-hidden="true"></i></span>
				</button>
			</div>
		...
		<td class="sui-table-item-title">
			...
			<span class="hui-app--wrap">
				...
				<span class="hui-app--link"><a href="{{editUrl}}" target="_blank" class="sui-button-icon">
					...
					<span class="sui-screen-reader-text"><?php esc_html_e( 'Edit your module integrations', 'wordpress-popup' ); ?></span>
				</a></span>
			</span>
...
<script id="hustle-modules-active-integration-header-tpl" type="text/template">
	...
	<?php // Title ?>
	<h3 id="dialogTitle" class="sui-box-title"> <?php esc_html_e( 'Disconnect ', 'wordpress-popup' ); ?> {{ title }}</h3>
...
<script id="hustle-modules-active-integration-desc-tpl" type="text/template">
	...
	<?php // Title ?>
	<p class="sui-description">{{title}}<?php esc_html_e( " is active (collecting data) on the following modules. Are you sure you wish to disconnect it? Note that if disconnecting this app results into modules without an active app, we'll activate the Hustle's Local List for those modules.", 'wordpress-popup' ); ?></p>
